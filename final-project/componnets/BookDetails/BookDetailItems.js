...
import UserModal from '../ProfileData/UserModal';
import ExchangeInfoModal from './ExchangeInfoModal';
      ...
      <View style={styles.container}>
         ...
         <View style={styles.tradeWrapper}>
            <View style={styles.tradeItems}>
               <BookTradeContainer onPressModal={openInfoModalHandler} />
            </View>
            <View style={styles.tradeItems}>
         ...
         <UserModal
            onShow={infoModalIsVisible}
            onHideModal={closeInfoModalHandler}
            formData={<ExchangeInfoModal onClose={closeInfoModalHandler} />}
